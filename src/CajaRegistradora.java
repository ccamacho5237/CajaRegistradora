...
public class CajaRegistradora extends javax.swing.JFrame {
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Bienvenidos al Sistema de Caja Registradora en los Mercados Familiares");
        ...
        if(value.equals("Agregar al Inventario")){
            if(i==0){
                try{
                    ...
                    JOptionPane.showMessageDialog(this, "Ingreso mal la informacion nananana ","Error",JOptionPane.ERROR_MESSAGE);
                } 
            }else{
                try{
                    if(i==1){
    ...
    public void Autocomplete(Inventario[] inventario) {
        TextAutoCompleter textAutocompleter = new TextAutoCompleter(txtValor);
        for (int i =0;i<20;i++) {
            textAutocompleter.addItem(inventario[i].getProducto());
        }
    }
